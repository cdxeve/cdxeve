...
* **Adapting Large Language Models via Reading Comprehension**  
  **Daixuan Cheng**, Shaohan Huang, Furu Wei  
  (**ICLR 2024 —  Earliest Research on Domain LLMs, 500K+ Downloads on Hugging Face, [#1 Trending of ALL Domain LLMs on Huggingface](https://huggingface.co/AdaptLLM), [🤗 #2 Paper of the Day](https://huggingface.co/papers/2309.09530)**) [pdf](https://huggingface.co/papers/2309.09530) [code](https://github.com/microsoft/LMOps/tree/main/adaptllm) [huggingface](https://huggingface.co/AdaptLLM)
